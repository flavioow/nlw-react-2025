        ...
        <main className="max-w-[1240px] mx-auto px-5 py-8 md:py-0">
            <div className="min-h-dvh flex flex-col justify-center gap-16">
                <div className="flex flex-col gap-8 items-center md:items-start">
                    ...
                    <h1 className="text-4xl text-center leading-none font-heading font-medium flex-col md:text-7xl md:text-left">
                ...
                <div className="flex gap-5 items-stretch flex-col md:flex-row">
                    ...
                    <form className="bg-gray-700 boder border-gray-600 rounded-2xl p-8 space-y-6 w-full md:max-w-[440px]">
                        <h2 className="font-heading font-semibold text-gray-200 text-xl">
                            Inscrição
                        </h2>
